...
# Kernel base version
KERNEL_BASE_VERSION = 4.9-292

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.usbconfigfs=true androidboot.bootdevice=7824900.sdhci earlycon=msm_hsl_uart,0x78af000 loop.max_part=7 console=tty0 droidian.lvm.prefer 
...
DEVICE_FULL_NAME = Xiaomi Redmi 5
...
# enabled.
#KERNEL_PRODUCT_DIFFCONFIG = rosy-perf-halium_defconfig

# Defconfig to use
KERNEL_DEFCONFIG = rosy-perf-halium_defconfig
...
BUILD_PATH = /usr/lib/llvm-android-10.0-r370808
